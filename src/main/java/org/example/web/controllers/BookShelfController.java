...
public class BookShelfController {
    ...
    public String uploadFile(@RequestParam(value = "file") MultipartFile file) throws Exception {
        ...
        logger.info("writing file " + serverFile.getAbsolutePath());
    ...
    public String handleMissingParts(Model model, MissingServletRequestPartException ex) {
        model.addAttribute("book", new Book());
        model.addAttribute("bookIdToRemove", new BookIdToRemove());
        model.addAttribute("bookList", bookService.getAllBooks());
        model.addAttribute("fileError", "File should be chosen");
